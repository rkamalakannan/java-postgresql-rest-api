...
CREATE TABLE IF NOT EXISTS trains (
	...
	"distance_between_stop" varchar NULL,
	"max_speed" varchar NULL,
	"sharing_tracks" varchar NULL,
	"grade_crossing" varchar NULL,
	"train_frequency" varchar NULL,
	amenities varchar NULL
);

insert
	into
	public.trains (id,"name",
	description,
